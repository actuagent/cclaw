...
func clearProviderEnv(t *testing.T) {
	t.Helper()
	t.Setenv("CCLAW_PROVIDER", "")
	t.Setenv("CCLAW_AGENT_MODEL", "")
	t.Setenv("CCLAW_MAX_TOKENS", "")
	t.Setenv("CCLAW_TEMPERATURE", "")
	t.Setenv("CCLAW_REASONING_EFFORT", "")
}
...
func TestDefaultConfigPath(t *testing.T) {
	...
	if filepath.Base(DefaultConfigDir()) != ".cclaw" {
		t.Fatalf("DefaultConfigDir() = %q, want ending .cclaw", DefaultConfigDir())
	}
}
...
func TestLoadDefaults(t *testing.T) {
	...
	home := os.Getenv("HOME")
	wantMemory := filepath.Join(home, ".cclaw", "memory")
...
func TestLoadEnvOverrides(t *testing.T) {
	...
	t.Setenv("CCLAW_PROVIDER", "qwen")
	t.Setenv("CCLAW_AGENT_MODEL", "qwen-max")
	t.Setenv("CCLAW_MAX_TOKENS", "4096")
	t.Setenv("CCLAW_TEMPERATURE", "0.2")
	t.Setenv("CCLAW_REASONING_EFFORT", "high")
...
`
	...
	t.Setenv("CCLAW_PROVIDER", "openai")
