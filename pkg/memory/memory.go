...
%s`, displayMemory, formatMessages(messages))
	...
	chatMessages := []*schema.Message{
		schema.SystemMessage("You are a memory consolidation agent for cclaw 🐈. Call the save_memory tool with your consolidation of the conversation. You MUST use the save_memory tool."),
